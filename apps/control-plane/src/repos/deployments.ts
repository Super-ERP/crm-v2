  ...
  try {
    await database.batch([
      ...
      database.prepare(
        ...
        input.heartbeat.supportedEntitlementSchemaVersion ?? null,
        input.observedAt,
      ),
      audit.statement,
    ])
